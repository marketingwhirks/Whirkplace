...
import { getWeekStartCentral, getCheckinDueDate, getCheckinWeekFriday } from './shared/utils/dueDates.js';
...
// Test getWeekStartCentral - should return Monday, October 7, 2025
...
// Check if week start is correct (Monday Oct 7)
...
// Check if due date is correct (Thursday Oct 10)
...
// Check if week Friday is correct (Friday Oct 11)
